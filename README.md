...
# Output video 
By default, The output video showing the system in action on a low compute power device is saved under[/outputs](https://github.com/VAISHNAVIV27/Yolo-V4-Object-Tracking/blob/main/outputs)
